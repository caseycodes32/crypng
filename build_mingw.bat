...
@set SOURCES=main.cpp image_handler.cpp image_processor.cpp aes.c imgui/backends/imgui_impl_opengl3.cpp imgui/backends/imgui_impl_win32.cpp imgui/imgui*.cpp
